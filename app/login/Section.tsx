        ...
        try {
            if (email && password) {
                ...
                if (response.data.status == true) {
                    if (response.data.data.user[0].kd_access[0].lvid == 2) {
                    ...
                    <div className="min-h-[40vh]">
                        <div className="card-body">
                            <div className="flex gap-5 items-center">
                                ...
                                <div className="text-4xl text-white drop-shadow-lg uppercase font-bold">
                                    Jurusan Ku
                                </div>
                            </div>
                            {notifError && (
                            ...
                            <div className="text-gray-900 uppercase font-bold text-2xl mt-5">
                                SIGN IN
                            </div>
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="text-xs font-thin text-center">
                                    <span className="text-lime-600">* </span>Jika lupa password
                                    hubungi admin
                                </div>
                            </div>
                        </div>
