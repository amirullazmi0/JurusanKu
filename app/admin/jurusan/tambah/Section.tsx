...
const Section = () => {
    ...
    return (
        <React.Fragment>
            {notifSuccess &&
                alertSuccess({
                    title: "Tambah Jurusan Successfully",
                    text: "Direct to jurusan",
                })}
                        ...
                        <div className="grid lg:grid-cols-3 gap-3">
                            ...
                            <div className="form-control lg:col-span-2">
                                ...
                                {errors.nama_juruasan && (
                                    <div className="p-1 text-xs bg-error text-white capitalize w-fit rounded mt-2">
                                        {errors.nama_juruasan.message}
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="lg:col-span-3">
                                <button
                                    ...
                                    className="btn btn-primary uppercase text-white w-full"
                                >
                                    tambah
                                </button>
                            </div>
