                    ...
                    <div className="drawer">
                        ...
                        <div className="drawer-side z-50">
                            ...
                            <ul className="menu p-4 lg:w-80 w-60 min-h-full bg-white text-base-content gap-2">
                                ...
                                <button onClick={() => navigation.push('/student')} className={`btn  ${active == 'dashboard' ? 'btn-info text-white' : 'btn-ghost'}`} >
                                ...
                                <button onClick={() => navigation.push('/student/input-nilai')} className={`btn  ${active == 'input-nilai' ? 'btn-info text-white' : 'btn-ghost'}`} >
                                    <div className="flex justify-between items-center w-full">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                ...
                                <button onClick={() => navigation.push('/student/profile')} className={`btn  ${active == 'profile' ? 'btn-info text-white' : 'btn-ghost'}`} >
                                    <div className="flex justify-between items-center w-full">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
